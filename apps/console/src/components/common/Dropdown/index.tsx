...
export function DropdownItem({
    ...
    const classes = clsx(
        ...
        // Focus
        'data-focus:bg-pink-600 data-focus:text-white',
        // Disabled state
...
export function DropdownDescription({
    ...
    return (
        <Headless.Description
            ...
            className={clsx(
                className,
                'col-span-2 col-start-2 row-start-2 text-sm/5 text-zinc-500 group-data-focus:text-white sm:text-xs/5 dark:text-zinc-400'
            )}
        />
    );
}
