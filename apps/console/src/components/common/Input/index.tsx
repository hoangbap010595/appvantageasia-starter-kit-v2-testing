...
import type { DetailedHTMLProps, ForwardedRef, InputHTMLAttributes, ReactNode, MouseEvent } from 'react';
    ...
    const input = (
        <InputGroup disabled={props.disabled} inputState={inputState}>
            ...
            <input
                ...
                className={clsx(
                    // base
                    'w-full grow border-0 px-0 py-1.5 shadow-none placeholder:text-gray-400 sm:text-sm sm:leading-6',
                    // focus
                    'focus:ring-0',
